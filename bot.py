...
<<<<<<< HEAD
            if HYPE_CHANNEL_ID and (self.god or any(x.get("rarity") in ("SR", "IR", "SSR") for x in self.pulls_sorted)):
                ...
                if chan:
                    ...
                    big = [x for x in self.pulls_sorted if x.get("rarity") in ("SR","IR","SSR")]
                    if self.god:
        ...
        async def _maybe_hype(self, itx: discord.Interaction, card: dict):
            ...
            try:
                ...
                if img:
                    emb = discord.Embed(color=0xFFD166 if rarity == "SSR" else 0xa855f7 if rarity == "IR" else 0xFFA654)
